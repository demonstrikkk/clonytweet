 ...
 // make sure page is not static

import UserDetailsViaLoginClient from "./userdetailsvialoginclient";

export default function UserDetailsViaLogin() {
  return <UserDetailsViaLoginClient />;
}
